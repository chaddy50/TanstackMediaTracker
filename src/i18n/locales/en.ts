export const en = {
	...
	viewGroups: {
		newGroup: "New Group",
		// The sidebar's add row is narrow and the icon already says "add".
		addButton: "Group",
		createGroup: "Create Group",
		editGroup: "Edit Group",
		deleteGroup: "Delete Group",
		name: "Name",
		namePlaceholder: "e.g. Currently reading",
	...
	views: {
		...
		reorder: "Reorder",
		reorderPosition: "Position {{position}} of {{count}}",
		reorderPositionInGroup: "Position {{position}} of {{count}} in {{group}}",
		doneReordering: "Done",
